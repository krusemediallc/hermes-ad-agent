...
2. **Then once live:** `python3 scripts/meta_token_maintenance.py --markdown --hermes-test`. Read the headline. `NO_CHANGE` (the detail line may say `REPLACED_SAME_EXPIRY`) on a token with plenty of days left is a healthy first run.
